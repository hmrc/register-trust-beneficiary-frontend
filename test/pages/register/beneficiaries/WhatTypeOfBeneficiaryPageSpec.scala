...
import pages.register.beneficiaries.companyoremploymentrelated.{
  CompanyOrEmploymentRelatedPage, company, employmentRelated => large
}
...
class WhatTypeOfBeneficiaryPageSpec extends PageBehaviours {
  ...
  implicit class UserAnswersSetters(userAnswers: UserAnswers) {
    ...
    def setWithStatus(status: Status): UserAnswers = userAnswers
      ...
      .value
      .set(ind.NamePage(0), name)
      .value
      .set(IndividualBeneficiaryStatus(0), status)
      .value
      .set(cob.ClassBeneficiaryDescriptionPage(0), string)
      .value
      .set(ClassBeneficiaryStatus(0), status)
      .value
      ...
      .value
      .set(other.DescriptionPage(0), string)
      .value
      .set(OtherBeneficiaryStatus(0), status)
      .value
