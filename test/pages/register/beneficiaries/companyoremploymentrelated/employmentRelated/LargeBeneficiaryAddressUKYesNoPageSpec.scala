    ...
    forAll(arbitrary[UserAnswers]) {
      initial =>
        val answers: UserAnswers =
          initial.set(LargeBeneficiaryAddressPage(0), UKAddress("line1", "line2", Some("line3"), Some("line4"), "AB1 1AB")).success.value
          .set(LargeBeneficiaryAddressInternationalPage(0), InternationalAddress("line1", "line2", Some("line3"), "AP")).success.value

        val result = answers.set(LargeBeneficiaryAddressUKYesNoPage(0), false).success.value
  ...
  "remove international address page when LargeBeneficiaryAddressUKYesNoPage is set to true" in {
    forAll(arbitrary[UserAnswers]) {
      initial =>
        ...
        val result = answers.set(LargeBeneficiaryAddressUKYesNoPage(0), true).success.value
