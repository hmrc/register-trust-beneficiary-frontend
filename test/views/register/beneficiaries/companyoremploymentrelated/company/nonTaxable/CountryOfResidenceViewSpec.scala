...
package views.register.beneficiaries.companyoremploymentrelated.company.nonTaxable
...
import views.html.register.beneficiaries.companyoremploymentrelated.company.nonTaxable.CountryOfResidenceView

class CountryOfResidenceViewSpec extends SelectCountryViewBehaviours {

  val prefix = "companyBeneficiary.nonTaxable.countryOfResidence"
  val index = 0
  val trustName = "Test"
