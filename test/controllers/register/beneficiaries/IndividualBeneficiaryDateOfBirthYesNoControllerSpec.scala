...
import views.html.register.beneficiaries.IndividualBeneficiaryDateOfBirthYesNoView
...
class IndividualBeneficiaryDateOfBirthYesNoControllerSpec extends SpecBase {
  ...
  "IndividualBeneficiaryDateOfBirthYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[IndividualBeneficiaryDateOfBirthYesNoView]
