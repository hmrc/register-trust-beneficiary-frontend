...
import models.CompanyOrEmploymentRelatedToAdd.EmploymentRelated
...
class CheckDetailsControllerSpec extends SpecBase {
  ...
  override def emptyUserAnswers: UserAnswers = super.emptyUserAnswers
    .set(WhatTypeOfBeneficiaryPage, CompanyOrEmployment)
    .value
    .set(CompanyOrEmploymentRelatedPage, EmploymentRelated)
    .value
  ...
  "CheckDetailsController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val mockPrintHelper: EmploymentRelatedBeneficiaryPrintHelper = mock[EmploymentRelatedBeneficiaryPrintHelper]
      ...
      val application = applicationBuilder(userAnswers = Some(emptyUserAnswers))
        .overrides(bind[EmploymentRelatedBeneficiaryPrintHelper].toInstance(mockPrintHelper))
        .build()
