...
import pages.register.beneficiaries.large.{LargeBeneficiaryAddressPage, LargeBeneficiaryNamePage}
...
class UkAddressControllerSpec extends SpecBase with MockitoSugar {
  ...
  "UkAddress Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = baseAnswers.set(LargeBeneficiaryAddressPage(index), answer).success.value
