...
import pages.register.beneficiaries.companyoremploymentrelated.employmentRelated.{CountryOfResidenceInTheUkYesNoPage, LargeBeneficiaryNamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.companyoremploymentrelated.employmentRelated.CountryOfResidenceInTheUkYesNoView

class CountryOfResidenceInTheUkYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new YesNoFormProvider()
  val form: Form[Boolean] = formProvider.withPrefix("employmentRelatedBeneficiary.countryOfResidenceInTheUkYesNo")
  val index: Int = 0
  val name = "Test"
  ...
  "CountryOfResidenceInTheUkYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(LargeBeneficiaryNamePage(index), name).success.value
