...
import views.html.register.beneficiaries.companyoremploymentrelated.employmentRelated.CountryOfResidenceView

class CountryOfResidenceControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new CountryFormProvider()
  val form: Form[String] = formProvider.withPrefix("employmentRelatedBeneficiary.countryOfResidence")
  val index: Int = 0
  val name = "Test"
