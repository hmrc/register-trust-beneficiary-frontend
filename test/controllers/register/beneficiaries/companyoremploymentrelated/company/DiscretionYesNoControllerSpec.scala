...
import pages.register.beneficiaries.company.{DiscretionYesNoPage, NamePage}
...
class DiscretionYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val discretionYesNoRoute: String = routes.DiscretionYesNoController.onPageLoad(NormalMode, index, draftId).url
