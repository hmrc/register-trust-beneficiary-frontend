...
import pages.register.beneficiaries.company.{AddressYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.companyoremploymentrelated.company.AddressYesNoView
...
class AddressYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val addressYesNoRoute: String = routes.AddressYesNoController.onPageLoad(NormalMode, index, draftId).url
