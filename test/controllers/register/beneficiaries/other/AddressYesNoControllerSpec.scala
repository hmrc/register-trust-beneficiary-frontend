...
import pages.register.beneficiaries.other.{AddressYesNoPage, DescriptionPage}
...
class AddressYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  "AddressYesNo Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(true), description, index, draftId)(fakeRequest, messages).toString
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, description, index, draftId)(fakeRequest, messages).toString
