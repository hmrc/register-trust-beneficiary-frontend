...
import pages.register.beneficiaries.other.{CountryOfResidenceYesNoPage, DescriptionPage}
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.other.CountryOfResidenceYesNoView
