...
class DescriptionControllerSpec extends SpecBase with MockitoSugar {
  ...
  "Description Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = emptyUserAnswers.set(DescriptionPage(index), description).success.value
      ...
      contentAsString(result) mustEqual
        view(form.fill(description), index, draftId)(fakeRequest, messages).toString
