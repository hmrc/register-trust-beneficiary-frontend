...
import views.html.register.beneficiaries.individual.AddressUKYesNoView
...
class AddressUKYesNoControllerSpec extends SpecBase {
  ...
  lazy val individualBeneficiaryAddressUKYesNoRoute = routes.AddressUKYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
