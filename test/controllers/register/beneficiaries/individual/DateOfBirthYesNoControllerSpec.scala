...
import pages.register.beneficiaries.individual.{IndividualBeneficiaryDateOfBirthYesNoPage, IndividualBeneficiaryNamePage}
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.individual.DateOfBirthYesNoView
...
class DateOfBirthYesNoControllerSpec extends SpecBase {
  ...
  lazy val individualBeneficiaryDateOfBirthYesNoRoute = routes.DateOfBirthYesNoController.onPageLoad(NormalMode, index, fakeDraftId).url
  ...
  "IndividualBeneficiaryDateOfBirthYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, individualBeneficiaryDateOfBirthYesNoRoute)
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(IndividualBeneficiaryDateOfBirthYesNoPage(index), true).success.value
