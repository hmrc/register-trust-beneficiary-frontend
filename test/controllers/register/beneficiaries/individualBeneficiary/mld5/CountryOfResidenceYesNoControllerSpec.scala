...
import pages.register.beneficiaries.individual.{CountryOfResidenceYesNoPage, NamePage}
...
class CountryOfResidenceYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  val form: Form[Boolean] = formProvider.withPrefix("individualBeneficiary.5mld.countryOfResidenceYesNo")
  val index: Int = 0
