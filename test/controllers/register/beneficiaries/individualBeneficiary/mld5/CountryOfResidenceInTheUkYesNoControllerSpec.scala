...
import pages.register.beneficiaries.individual.{CountryOfResidenceInTheUkYesNoPage, NamePage}
...
class CountryOfResidenceInTheUkYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  val form: Form[Boolean] = formProvider.withPrefix("individualBeneficiary.5mld.countryOfResidenceInTheUkYesNo")
  val index: Int = 0
