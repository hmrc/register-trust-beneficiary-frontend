...
import views.html.register.beneficiaries.individualBeneficiary.CountryOfResidenceYesNoView

class CountryOfResidenceYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new YesNoFormProvider()
  val form: Form[Boolean] = formProvider.withPrefix("individualBeneficiary.countryOfResidenceYesNo")
  val index: Int = 0
