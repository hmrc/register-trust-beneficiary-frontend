...
import pages.register.beneficiaries.individual.{CountryOfNationalityYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.individualBeneficiary.CountryOfNationalityYesNoView

class CountryOfNationalityYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new YesNoFormProvider()
  val form: Form[Boolean] = formProvider.withPrefix("individualBeneficiary.countryOfNationalityYesNo")
  val index: Int = 0
