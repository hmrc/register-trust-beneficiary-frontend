...
import pages.register.beneficiaries.individual.{MentalCapacityYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.individualBeneficiary.MentalCapacityYesNoView

class MentalCapacityYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new YesNoDontKnowFormProvider()
  val form: Form[YesNoDontKnow] = formProvider.withPrefix("individualBeneficiary.mentalCapacityYesNo")
  val index: Int = 0
