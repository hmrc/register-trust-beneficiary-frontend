...
import pages.register.beneficiaries.individual.{CountryOfNationalityPage, NamePage}
...
import views.html.register.beneficiaries.individualBeneficiary.CountryOfNationalityView

class CountryOfNationalityControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new CountryFormProvider()
  val form: Form[String] = formProvider.withPrefix("individualBeneficiary.countryOfNationality")
  val index: Int = 0
