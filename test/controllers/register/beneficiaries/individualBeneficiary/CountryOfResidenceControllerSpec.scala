...
import pages.register.beneficiaries.individual.{CountryOfResidencePage, NamePage}
...
import views.html.register.beneficiaries.individualBeneficiary.CountryOfResidenceView

class CountryOfResidenceControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new CountryFormProvider()
  val form: Form[String] = formProvider.withPrefix("individualBeneficiary.countryOfResidence")
  val index: Int = 0
