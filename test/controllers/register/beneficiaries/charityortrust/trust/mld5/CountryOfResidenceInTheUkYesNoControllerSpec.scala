...
package controllers.register.beneficiaries.charityortrust.trust.mld5
...
import pages.register.beneficiaries.charityortrust.trust.{CountryOfResidenceInTheUkYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.charityortrust.trust.mld5.CountryOfResidenceInTheUkYesNoView

class CountryOfResidenceInTheUkYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new YesNoFormProvider()
  val form: Form[Boolean] = formProvider.withPrefix("trust.5mld.countryOfResidenceInTheUkYesNo")
  val index: Int = 0
  val trustName = "Test"
