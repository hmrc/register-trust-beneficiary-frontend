...
import pages.register.beneficiaries.charityortrust.charity.{CharityNamePage, CountryOfResidenceYesNoPage}
import play.api.data.Form
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.charityortrust.charity.CountryOfResidenceYesNoView

class CountryOfResidenceYesNoControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new YesNoFormProvider()
  val form: Form[Boolean] = formProvider.withPrefix("charity.5mld.countryOfResidenceYesNo")
  val index: Int = 0
