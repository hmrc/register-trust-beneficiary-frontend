...
class RemoveCharityBeneficiaryControllerSpec extends SpecBase with ScalaCheckPropertyChecks {
  ...
  lazy val formRoute = routes.RemoveCharityBeneficiaryController.onSubmit(0, fakeDraftId)
  ...
  "RemoveCharityBeneficiary Controller" when {
    ...
    "no name added" must {
      "return OK and the correct view for a GET" in {
        ...
        val request = FakeRequest(GET, routes.RemoveCharityBeneficiaryController.onPageLoad(index, fakeDraftId).url)
