...
import controllers.register.charityOrTrust.routes
import forms.{CharityOrTrustFormProvider, YesNoFormProvider}
import models.NormalMode
import org.scalatestplus.mockito.MockitoSugar
import pages.register.beneficiaries.charityOrTrust.{AmountDiscretionYesNoPage, CharityNamePage, CharityOrTrustPage}
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.charityOrTrust.{AmountDiscretionYesNoView, CharityOrTrustView}
...
class AmountDiscretionYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  val form = formProvider.withPrefix("amountDiscretionYesNo")
  val index: Int = 0
  val charityName = "Test"

  lazy val amountDiscretionYesNo: String = controllers.register.charityOrTrust.routes.AmountDiscretionYesNoController.onPageLoad(NormalMode, index, draftId).url
