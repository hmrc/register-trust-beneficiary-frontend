...
import pages.register.beneficiaries.charityOrTrust.{AddressInTheUkYesNoPage, AmountDiscretionYesNoPage, CharityAddressUKPage, CharityNamePage, CharityOrTrustPage, HowMuchIncomePage}
...
import views.html.register.beneficiaries.charityOrTrust.CharityAnswersView
