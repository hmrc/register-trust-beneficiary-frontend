...
import models.{NormalMode, ReadOnlyUserAnswers, UserAnswers}
...
class CharityNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val charityNameRoute = controllers.register.charityOrTrust.routes.CharityNameController.onPageLoad(NormalMode, index, fakeDraftId).url
