...
import pages.register.beneficiaries.charityOrTrust.{AddressInTheUkYesNoPage, CharityNamePage}
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.register.beneficiaries.charityOrTrust.AddressInTheUkYesNoView
...
class AddressInTheUkYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  val form = formProvider.withPrefix("addressInTheUkYesNo")
  val index: Int = 0
  val charityName = "Test"

  lazy val addressInTheUkYesNo = controllers.register.charityOrTrust.routes.AddressInTheUkYesNoController.onPageLoad(NormalMode, index, draftId).url
