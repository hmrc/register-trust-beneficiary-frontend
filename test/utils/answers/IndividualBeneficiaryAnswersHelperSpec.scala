  ...
  "Individual beneficiary answers helper" must {
    ...
    "return an individual beneficiary answer section" in {
      ...
      val userAnswers = emptyUserAnswers
        ...
        .value
        .set(RoleInCompanyPage(index), RoleInCompany.Director)
        .value
        ...
        .value
        .set(CountryOfNationalityPage(index), country)
        .value
        ...
        .value
        .set(VulnerableYesNoPage(index), false)
        .value
          ...
          AnswerSection(
            ...
            rows = Seq(
              ...
              AnswerRow(
                ...
                Html("Director"),
                Some(RoleInCompanyController.onPageLoad(index, fakeDraftId).url),
                arg,
                canEdit
              ),
              AnswerRow(
              ...
              AnswerRow(
                ...
                Html("No"),
                Some(IncomeYesNoController.onPageLoad(index, fakeDraftId).url),
                arg,
                canEdit
              ),
              AnswerRow(
                ...
                Html("50%"),
                Some(IncomeController.onPageLoad(index, fakeDraftId).url),
                arg,
                canEdit
              ),
              AnswerRow(
              ...
              AnswerRow(
                ...
                Some(AddressUKController.onPageLoad(index, fakeDraftId).url),
                arg,
                canEdit
              ),
              AnswerRow(
                ...
                Some(AddressInternationalController.onPageLoad(index, fakeDraftId).url),
                arg,
                canEdit
              ),
              AnswerRow(
              ...
              AnswerRow(
                ...
                Html("No"),
                Some(VulnerableYesNoController.onPageLoad(index, fakeDraftId).url),
                arg,
                canEdit
              )
            ),
