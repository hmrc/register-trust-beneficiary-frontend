...
import pages.register.beneficiaries.companyoremploymentrelated.company.{CountryOfResidenceInTheUkYesNoPage, NamePage}
import play.api.data.Form
import play.api.i18n._
import play.api.mvc._
import repositories.RegistrationsRepository
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.register.beneficiaries.companyoremploymentrelated.company.CountryOfResidenceInTheUkYesNoView
...
class CountryOfResidenceInTheUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("companyBeneficiary.countryOfResidenceInTheUkYesNo")
