...
import pages.register.beneficiaries.companyoremploymentrelated.company.AddressYesNoPage
...
class AddressYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("companyBeneficiary.addressYesNo")
