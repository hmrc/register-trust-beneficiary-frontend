...
import views.html.register.beneficiaries.companyoremploymentrelated.company.CountryOfResidenceYesNoView
...
class CountryOfResidenceYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("companyBeneficiary.countryOfResidenceYesNo")
