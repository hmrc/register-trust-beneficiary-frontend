...
import pages.register.beneficiaries.companyoremploymentrelated.company.{CountryOfResidencePage, NamePage}
...
import views.html.register.beneficiaries.companyoremploymentrelated.company.CountryOfResidenceView
...
class CountryOfResidenceController @Inject()(
  ...
  private val form: Form[String] = formProvider.withPrefix("companyBeneficiary.countryOfResidence")
