...
import pages.register.beneficiaries.companyoremploymentrelated.employmentRelated.CountryOfResidenceInTheUkYesNoPage
...
class CountryOfResidenceInTheUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("employmentRelatedBeneficiary.countryOfResidenceInTheUkYesNo")
