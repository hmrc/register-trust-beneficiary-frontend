...
import pages.register.beneficiaries.companyoremploymentrelated.employmentRelated.CountryOfResidenceYesNoPage
...
class CountryOfResidenceYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("employmentRelatedBeneficiary.countryOfResidenceYesNo")
