...
import views.html.register.beneficiaries.individual.AnswersView
...
class AnswersController @Inject()(
  ...
  private def actions(index: Int, draftId: String) =
    identify andThen
      ...
      requireData andThen
      requiredAnswer(RequiredAnswer(IndividualBeneficiaryNamePage(index), routes.NameController.onPageLoad(NormalMode, 0, draftId)))
