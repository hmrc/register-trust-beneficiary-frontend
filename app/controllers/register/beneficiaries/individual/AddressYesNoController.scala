...
import views.html.register.beneficiaries.individual.AddressYesNoView
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value => {
          ...
          } yield Redirect(navigator.nextPage(IndividualBeneficiaryAddressYesNoPage(index), mode, draftId)(updatedAnswers))
        }
      )
  }
}
