...
import views.html.register.beneficiaries.individual.NationalInsuranceYesNoView
...
class NationalInsuranceYesNoController @Inject()(
  ...
  def onPageLoad(mode: Mode, index: Int, draftId: String): Action[AnyContent] = actions(index, draftId) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(IndividualBeneficiaryNationalInsuranceYesNoPage(index)) match {
        case None => form
