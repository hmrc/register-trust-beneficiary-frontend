...
import views.html.register.beneficiaries.individual.IncomeYesNoView
...
class IncomeYesNoController @Inject()(
  ...
  def onPageLoad(mode: Mode, index: Int, draftId: String): Action[AnyContent] = actions(index, draftId) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(IndividualBeneficiaryIncomeYesNoPage(index)) match {
        case None => form
