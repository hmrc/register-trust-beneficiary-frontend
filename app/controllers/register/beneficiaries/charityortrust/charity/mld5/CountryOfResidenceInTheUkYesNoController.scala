...
package controllers.register.beneficiaries.charityortrust.charity.mld5
...
import views.html.register.beneficiaries.charityortrust.charity.mld5.CountryOfResidenceInTheUkYesNoView
...
class CountryOfResidenceInTheUkYesNoController @Inject() (
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("charity.5mld.countryOfResidenceInTheUkYesNo")
      ...
      form
        ...
        .fold(
          ...
          value => {
            val result = for {
              updatedAnswers <-
                EitherT(Future.successful(request.userAnswers.set(CountryOfResidenceInTheUkYesNoPage(index), value)))
