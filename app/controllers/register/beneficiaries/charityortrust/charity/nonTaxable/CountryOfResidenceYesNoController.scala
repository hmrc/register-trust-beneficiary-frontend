...
package controllers.register.beneficiaries.charityortrust.charity.nonTaxable
...
import pages.register.beneficiaries.charityortrust.charity.nonTaxable.CountryOfResidenceYesNoPage
import views.html.register.beneficiaries.charityortrust.charity.nonTaxable.CountryOfResidenceYesNoView
...
class CountryOfResidenceYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("charity.nonTaxable.countryOfResidenceYesNo")
