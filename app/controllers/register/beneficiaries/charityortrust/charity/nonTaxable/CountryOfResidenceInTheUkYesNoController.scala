...
import views.html.register.beneficiaries.charityortrust.charity.nonTaxable.CountryOfResidenceInTheUkYesNoView
...
class CountryOfResidenceInTheUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("charity.nonTaxable.countryOfResidenceInTheUkYesNo")
