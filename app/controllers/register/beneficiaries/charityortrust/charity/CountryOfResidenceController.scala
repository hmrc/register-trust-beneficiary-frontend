...
import views.html.register.beneficiaries.charityortrust.charity.CountryOfResidenceView
...
class CountryOfResidenceController @Inject()(
  ...
  private val form: Form[String] = formProvider.withPrefix("charity.countryOfResidence")
