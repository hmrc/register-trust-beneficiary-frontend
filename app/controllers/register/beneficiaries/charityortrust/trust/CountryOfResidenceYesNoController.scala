...
import pages.register.beneficiaries.charityortrust.trust.CountryOfResidenceYesNoPage
...
class CountryOfResidenceYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("trust.countryOfResidenceYesNo")
