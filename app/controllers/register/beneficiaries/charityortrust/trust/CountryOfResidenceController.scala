...
import pages.register.beneficiaries.charityortrust.trust.CountryOfResidencePage
...
import views.html.register.beneficiaries.charityortrust.trust.CountryOfResidenceView
...
class CountryOfResidenceController @Inject()(
  ...
  private val form: Form[String] = formProvider.withPrefix("trust.countryOfResidence")
