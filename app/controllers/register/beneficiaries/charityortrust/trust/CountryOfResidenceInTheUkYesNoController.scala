...
import pages.register.beneficiaries.charityortrust.trust.CountryOfResidenceInTheUkYesNoPage
...
class CountryOfResidenceInTheUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("trust.countryOfResidenceInTheUkYesNo")
