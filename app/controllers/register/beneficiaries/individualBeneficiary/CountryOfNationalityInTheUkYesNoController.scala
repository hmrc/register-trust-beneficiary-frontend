...
import pages.register.beneficiaries.individual.CountryOfNationalityInTheUkYesNoPage
import play.api.data.Form
import play.api.i18n._
import play.api.mvc._
import repositories.RegistrationsRepository
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.register.beneficiaries.individualBeneficiary.CountryOfNationalityInTheUkYesNoView
...
class CountryOfNationalityInTheUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("individualBeneficiary.countryOfNationalityInTheUkYesNo")
