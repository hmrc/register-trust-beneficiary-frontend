...
import pages.register.beneficiaries.individual.CountryOfResidencePage
...
class CountryOfResidenceController @Inject()(
  ...
  private val form: Form[String] = formProvider.withPrefix("individualBeneficiary.countryOfResidence")
