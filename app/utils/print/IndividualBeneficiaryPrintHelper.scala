  ...
  override def answers(userAnswers: UserAnswers, name: String, index: Int, draftId: String)(implicit
    ...
    Seq(
      ...
      bound.roleInCompanyQuestion(
        RoleInCompanyPage(index),
        "individualBeneficiaryRoleInCompany",
        RoleInCompanyController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
      ...
      bound.dateQuestion(
        ...
        "individualBeneficiaryDateOfBirth",
        DateOfBirthController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        IncomeYesNoPage(index),
        "individualBeneficiaryIncomeYesNo",
        IncomeYesNoController.onPageLoad(index, draftId).url
      ),
      bound.percentageQuestion(
        IncomePage(index),
        "individualBeneficiaryIncome",
        IncomeController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        CountryOfNationalityYesNoPage(index),
        "individualBeneficiary.5mld.countryOfNationalityYesNo",
        CountryOfNationalityYesNoController.onPageLoad(index, draftId).url
      ),
      bound.yesNoQuestion(
        CountryOfNationalityInTheUkYesNoPage(index),
        "individualBeneficiary.5mld.countryOfNationalityInTheUkYesNo",
        CountryOfNationalityInTheUkYesNoController.onPageLoad(index, draftId).url
      ),
      bound.countryQuestion(
        CountryOfNationalityInTheUkYesNoPage(index),
        CountryOfNationalityPage(index),
        "individualBeneficiary.5mld.countryOfNationality",
