...
class CompanyBeneficiaryPrintHelper @Inject()(answerRowConverter: AnswerRowConverter) extends PrintHelper {
  ...
  override def answers(userAnswers: UserAnswers, name: String, index: Int, draftId: String)
    ...
    Seq(
      ...
      bound.yesNoQuestion(CountryOfResidenceYesNoPage(index), "companyBeneficiary.countryOfResidenceYesNo", CountryOfResidenceYesNoController.onPageLoad(index, draftId).url),
      bound.yesNoQuestion(CountryOfResidenceInTheUkYesNoPage(index), "companyBeneficiary.countryOfResidenceInTheUkYesNo", CountryOfResidenceInTheUkYesNoController.onPageLoad(index, draftId).url),
      bound.countryQuestion(CountryOfResidenceInTheUkYesNoPage(index), CountryOfResidencePage(index), "companyBeneficiary.countryOfResidence", CountryOfResidenceController.onPageLoad(index, draftId).url),
